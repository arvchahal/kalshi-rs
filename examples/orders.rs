...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // =========================================================================
    // SINGLE ORDER: Create and Cancel
    // =========================================================================
    ...
    let order_request = CreateOrderRequest {
        ...
        side: "yes".to_string(),
        count: 1,
        client_order_id: Some("example-order-1".to_string()),
    ...
    for i in 1..=3 {
        let req = CreateOrderRequest {
            ...
            side: "yes".to_string(),
            count: 1,
            client_order_id: Some(format!("batch-order-{}", i)),
            type_: Some("limit".to_string()),
    ...
    let batch_cancel_req = BatchCancelOrdersRequest {
