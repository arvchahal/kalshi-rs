...
[<img alt="build status" src="https://img.shields.io/github/actions/workflow/status/arnavchahal/kalshi-rs/ci.yml?branch=main&style=for-the-badge" height="20">](https://github.com/arvchahal/kalshi-rs/actions?query=branch%3Amaster)
